...
const AdminSidebar = ({ isSidebarExpanded, setSidebarExpanded }) => {
  ...
  return (
    <div onClick={handleSidebarExpand} className={`admin-sidebar  z-20 w-[50px] lg:w-[250px] bg-[#1E293B] px-4 py-2 flex flex-col items-center ${isSidebarExpanded ? "absolute md:relative w-auto md:w-[250px] min-h-screen shadow-md" : ""}`}>

...
const Hero = ({ imgUrl = menHero }) => {
  ...
  return (
    <div className={`bg-cover bg-right sm:bg-auto flex flex-col justify-center items-center`} style={style}>
      ...
      <input type="text" placeholder="search..." className="mt-3 min-h-8 text-[#676565] rounded-full w-full md:py-2 md:px-3 px-5 py-6 outline-none " id="search"/>
